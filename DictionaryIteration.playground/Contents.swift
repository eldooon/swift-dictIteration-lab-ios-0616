 ...
 */
// write your code here
bandAndAlbum.removeValueForKey("The Kinks")
...
// write your code here
if let album = bandAndAlbum[bandName] {
 ...
 */
// write your code here
for (grade, score) in gradesOfStudents {
...
var highestGrade = 0
for (grade, score) in gradesOfStudents {
    if let highestScore = gradesOfStudents[highestGrade] {
...
if let winningScore = gradesOfStudents[highestGrade] {
